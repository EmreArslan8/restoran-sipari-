...
const SEED_PRODUCTS = [
  { id: 1,  name: "Adana Kebap",        category: "Ana Yemek", price: 220, desc: "Acılı zırh kıyma, közlenmiş biber ve domates ile.", emoji: "🍢", active: true },
  { id: 2,  name: "Izgara Köfte",       category: "Ana Yemek", price: 185, desc: "El yapımı köfte, pilav ve garnitür.",             emoji: "🍖", active: true },
  { id: 3,  name: "Karışık Pizza",      category: "Pizza",     price: 240, desc: "Sucuk, mantar, biber, zeytin ve bol mozzarella.", emoji: "🍕", active: true },
  { id: 4,  name: "Margherita Pizza",   category: "Pizza",     price: 195, desc: "Domates sosu, mozzarella ve fesleğen.",          emoji: "🍕", active: true },
  { id: 5,  name: "Klasik Burger",      category: "Burger",    price: 165, desc: "120gr köfte, cheddar, marul, domates.",          emoji: "🍔", active: true },
  { id: 6,  name: "Tavuk Burger",       category: "Burger",    price: 150, desc: "Çıtır tavuk, özel sos ve turşu.",                 emoji: "🍔", active: true },
  { id: 7,  name: "Mercimek Çorbası",   category: "Çorba",     price: 70,  desc: "Geleneksel süzme mercimek, limon ile.",          emoji: "🍲", active: true },
  { id: 8,  name: "Ezogelin Çorbası",   category: "Çorba",     price: 75,  desc: "Baharatlı, doyurucu ve sıcacık.",                emoji: "🍲", active: true },
  { id: 9,  name: "Künefe",             category: "Tatlı",     price: 130, desc: "Antep fıstıklı, tel kadayıflı sıcak künefe.",    emoji: "🧆", active: true },
  { id: 10, name: "Sütlaç",             category: "Tatlı",     price: 90,  desc: "Fırında pişmiş geleneksel sütlaç.",              emoji: "🍮", active: true },
  { id: 11, name: "Ayran",              category: "İçecek",    price: 35,  desc: "Taze, köpüklü ayran.",                            emoji: "🥛", active: true },
  { id: 12, name: "Kola",               category: "İçecek",    price: 45,  desc: "330ml kutu.",                                     emoji: "🥤", active: true },
  { id: 13, name: "Şalgam",             category: "İçecek",    price: 40,  desc: "Acılı / acısız seçenekli.",                       emoji: "🧃", active: false },
];
