...
/* Restoran profili — gerçek bir sipariş sitesi hissi için meta bilgiler */
const RESTAURANT = {
  name: "Lezzet Durağı",
  slogan: "Ev yapımı lezzetler, komisyonsuz sipariş",
  rating: 4.7,
  ratingCount: 312,
  deliveryMin: 30,        // teslimat süresi (dk) alt
  deliveryMax: 45,        // teslimat süresi (dk) üst
  minOrder: 150,          // minimum sepet tutarı (₺)
  deliveryFee: 25,        // teslimat ücreti (₺)
  freeDeliveryOver: 300,  // bu tutar üzeri teslimat ücretsiz (₺)
  openHour: 10,           // açılış saati
  closeHour: 23,          // kapanış saati
  neighborhoods: ["Sanayi Sitesi", "Merkez", "Yeni Mahalle", "Çelik Cad.", "Organize Sanayi"],
};
...
const SEED_PRODUCTS = [
  { id: 1,  name: "Adana Kebap",        category: "Ana Yemek", price: 220, desc: "Acılı zırh kıyma, közlenmiş biber ve domates ile.", emoji: "🍢", img: IMG("kebab,grill", 11),      popular: true,             active: true },
  { id: 2,  name: "Izgara Köfte",       category: "Ana Yemek", price: 185, oldPrice: 210, desc: "El yapımı köfte, pilav ve garnitür.",     emoji: "🍖", img: IMG("meatballs", 22),                                    active: true },
  { id: 3,  name: "Karışık Pizza",      category: "Pizza",     price: 240, oldPrice: 285, desc: "Sucuk, mantar, biber, zeytin ve bol mozzarella.", emoji: "🍕", img: IMG("pizza", 33),  popular: true,             active: true },
  ...
  { id: 5,  name: "Klasik Burger",      category: "Burger",    price: 165, desc: "120gr köfte, cheddar, marul, domates.",          emoji: "🍔", img: IMG("burger", 55),           popular: true,             active: true },
  { id: 6,  name: "Tavuk Burger",       category: "Burger",    price: 150, desc: "Çıtır tavuk, özel sos ve turşu.",                 emoji: "🍔", img: IMG("chicken,burger", 66),   isNew: true,               active: true },
  ...
  { id: 9,  name: "Künefe",             category: "Tatlı",     price: 130, desc: "Antep fıstıklı, tel kadayıflı sıcak künefe.",    emoji: "🧆", img: IMG("baklava,dessert", 99),  popular: true,             active: true },
  ...
  { id: 13, name: "Şalgam",             category: "İçecek",    price: 40,  desc: "Acılı / acısız seçenekli.",                       emoji: "🧃", img: IMG("juice,glass", 131),     isNew: true,               active: false },
];
